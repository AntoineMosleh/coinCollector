...
public class MainActivity extends AppCompatActivity {
    ...
    public void downloadAndInsertCoin(final int year, final String rarity, final int quantity, final double value, String imageUrl) {
        ...
        new Thread(() -> {
            try {
                ...
                runOnUiThread(() -> {
                    db.insertCoin(year, rarity, quantity, value, bitmap);
